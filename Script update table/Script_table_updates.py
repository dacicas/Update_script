...
release_localtest= []
while len(release_localtest) < 40:
    un_element = random.randrange(0, 37)
    release_localtest.append(locale[un_element])

release_localtest_set = set(release_localtest)

release_localtest_2 = [*release_localtest_set]
...
locale_cdntest = []
while len(locale_cdntest) < 35:
     un_element = random.randrange(0, 37)
     locale_cdntest.append(locale[un_element])

set_cdntest = set(locale_cdntest)

locale_cdntest_2 = [*set_cdntest]
print('LOCALE RELEASE-CDNTEST:')
print(locale_cdntest_2[0:20])

sheet.update_cell(67, 4, (locale_cdntest_2[0]))
sheet.update_cell(68, 4, (locale_cdntest_2[1]))
sheet.update_cell(69, 4, (locale_cdntest_2[2]))
sheet.update_cell(70, 4, (locale_cdntest_2[3]))
sheet.update_cell(71, 4, (locale_cdntest_2[4]))
sheet.update_cell(72, 4, (locale_cdntest_2[5]))
sheet.update_cell(73, 4, (locale_cdntest_2[6]))
sheet.update_cell(74, 4, (locale_cdntest_2[7]))
sheet.update_cell(75, 4, (locale_cdntest_2[8]))
sheet.update_cell(76, 4, (locale_cdntest_2[9]))
sheet.update_cell(77, 4, (locale_cdntest_2[10]))
sheet.update_cell(78, 4, (locale_cdntest_2[11]))
sheet.update_cell(79, 4, (locale_cdntest_2[12]))
sheet.update_cell(80, 4, (locale_cdntest_2[13]))
sheet.update_cell(81, 4, (locale_cdntest_2[14]))
sheet.update_cell(82, 4, (locale_cdntest_2[15]))
sheet.update_cell(83, 4, (locale_cdntest_2[16]))
sheet.update_cell(84, 4, (locale_cdntest_2[17]))
sheet.update_cell(85, 4, (locale_cdntest_2[18]))
sheet.update_cell(86, 4, (locale_cdntest_2[19]))
...
locale_release = []
while len(locale_release) < 35:
     un_element = random.randrange(0, 37)
     locale_release.append(locale[un_element])

set_release = set(locale_release)

locale_release_2 = [*set_release]
print('LOCALE RELEASE:')
print(locale_release_2[0:20])

sheet.update_cell(92, 4, (locale_release_2[0]))
sheet.update_cell(93, 4, (locale_release_2[1]))
sheet.update_cell(94, 4, (locale_release_2[2]))
sheet.update_cell(95, 4, (locale_release_2[3]))
sheet.update_cell(96, 4, (locale_release_2[4]))
sheet.update_cell(97, 4, (locale_release_2[5]))
sheet.update_cell(98, 4, (locale_release_2[6]))
sheet.update_cell(99, 4, (locale_release_2[7]))
sheet.update_cell(100, 4, (locale_release_2[8]))
sheet.update_cell(101, 4, (locale_release_2[9]))
sheet.update_cell(102, 4, (locale_release_2[10]))
sheet.update_cell(103, 4, (locale_release_2[11]))
sheet.update_cell(104, 4, (locale_release_2[12]))
sheet.update_cell(105, 4, (locale_release_2[13]))
sheet.update_cell(106, 4, (locale_release_2[14]))
sheet.update_cell(107, 4, (locale_release_2[15]))
sheet.update_cell(108, 4, (locale_release_2[16]))
sheet.update_cell(109, 4, (locale_release_2[17]))
sheet.update_cell(110, 4, (locale_release_2[18]))
sheet.update_cell(111, 4, (locale_release_2[19]))
